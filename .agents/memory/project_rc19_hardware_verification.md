...
description: "v1.5.0-rc.19+ shipped decompile-derived BLE changes pending real-hardware verification (8015/4508 sync, split writes, tea events, sleep-state mode-switch gating)"
metadata: 
  node_type: memory
  type: project
